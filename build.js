...
;
  ...
  ;
    ...
    Polymer('x-news', {
      ...
      onSlower: function () {
        console.log('slowerClicked..');
      },
      onToggleViewState: function () {
        this.playing = !this.playing;
        this.word = this.playing ? 'pause' : 'play';
        console.log('onToggleViedState clicked: %s..', this.playing);
      },
      onPrevArticle: function() {
        console.log('onPrevArticle clicked..');
      },
